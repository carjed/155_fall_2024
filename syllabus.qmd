...
**Showing growth:**  If, on a quiz, you demonstrate stronger understanding of the concepts that you missed on a PP, you have the chance to earn a higher score on the PP. You must email me a reflection that describes:

- where you missed points
- How you solidified your understanding of the concept before the quiz
- The relevant questions on the quiz where you demonstrated growth

You can do this once for each quiz (excluding the final), and you can show improvement on multiple PPs using a single quiz.
...
**Showing growth:** You can earn up to 50% of missed points back on quizzes if you email me a quiz correction and reflection. This must contain:

- A brief summary of how you prepared for the quiz
- The concepts you felt most confident and least prepared for
- Corrected answers, with a brief reflection that indicates you understand why/how your original answer was wrong
- If you also missed points on related practice problems, you must address any feedback you received on those problems to earn maximum credit back (but credit back **only** applies to the quiz, not the practice problems)
