...
# Multiplicative difference of 1.1, or 10%
log(1.1) * -18.142
```

On average, we expect the average individual in a country where the gross annual teaching salary is 10% greater to need to work 1.7 times fewer minutes to be able to afford a Big Mac.

**Note**: You could have chosen a different percentage difference and still have been correct! 
